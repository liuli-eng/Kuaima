...
export default {
  data() {
    return {
      ...
      dateActive: 0,
      jobTypeOptions: ['全部', '餐饮服务', '快递配送', '仓储物流', '制造业', '建筑装修', '零售促销', '家政服务'],
      jobTypeActive: 0,
      salaryOptions: ['不限', '100元以下', '100-200元', '200-300元', '300元以上', '日结周结'],
      salaryActive: 0,
      locationOptions: ['不限', '3公里内', '5公里内', '10公里内', '同城'],
      locationActive: 0,
      experienceOptions: ['不限', '新手可做', '有经验优先', '熟练工', '技术工人'],
      experienceActive: 0,
      genderOptions: ['不限', '男', '女', '男女均可'],
      genderActive: 0,
      tagOptions: ['包吃住', '有空调', '日结', '可长期', '报销路费', '提供工具'],
      tagActive: []
    }
  },
  methods: {
