...
public class BossAttendanceCodeService {
    private final BossAttendanceCodeRepository codes; private final BossRecruitSettingsService settings; private final UserRepository users; private final SecureRandom random = new SecureRandom();
    public BossAttendanceCodeService(BossAttendanceCodeRepository codes, BossRecruitSettingsService settings, UserRepository users) { this.codes = codes; this.settings = settings; this.users = users; }
    @Transactional
